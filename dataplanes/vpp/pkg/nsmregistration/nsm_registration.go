...
func livenessMonitor(vpp nsmvpp.Interface, registrationConnection dataplaneregistrarapi.DataplaneRegistrationClient) {
...
func RegisterDataplane(vpp nsmvpp.Interface) {
...
func UnRegisterDataplane(vpp nsmvpp.Interface) {
